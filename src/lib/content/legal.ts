...
export const defaultLegalDocument = legalDocumentSchema.parse({
  privacy: {
    ...
    intro:
      'This website collects limited information needed to publish content, secure admin access, and operate site infrastructure. Public visitors do not create accounts or submit stored forms on this website at this time.',
    body:
  ...
  terms: {
    title: 'Terms of Use',
    intro:
      'By using this website, you agree to use it lawfully and understand that site content, links, and materials are provided for informational and professional purposes.',
    body:
